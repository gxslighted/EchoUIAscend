...
license_textbox_1.FocusLost:Connect(function()
	...
	print("Entered Token:", license_textbox_1.Text)
	print("Lite Subscription:", litesubscription)
	print("Plus Subscription:", plussubscription)
	print("Bliss Subscription:", blisssubscription)
